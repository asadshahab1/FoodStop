...
const DeleteProducts = () => {
  ...
  const handleDelete = (product_id) =>{
    axios.post('http://localhost:3000/delete-product', {product_id}, {
      headers : {
        'Authorization': `${token}`,
        'seller_id' : `${sid}`
      }
    }).then((res)=>{
      console.log('delete krha', res)
      alert('Product Deleted')
    }).catch(e=> console.log('nh hoa', e))
  }
    ...
    <div className='sellerdashboard-main'>
      ...
      <div className="v-new-orders">
        ...
        <div className='order-heading d-flex py-2 gap-2 '>
          ...
          <p className="order-title-06 px-1">DELETE</p>
          ...
          {products.map((myitem, index)=>(
            ...
            <div className="row" key={myitem.ProductID} >
              ...
              <div className="order-detail d-flex">
                ...
                <button className='alika' onClick={()=> handleDelete(myitem.ProductID)}>
                  Delete
                </button>
